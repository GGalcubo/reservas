...
def getClienteById(request):
    ...
    for i in cliente.personacliente_set.all():
        if i.persona.baja is False:
            if (i.persona.tipo_persona.tipo_persona != 'Pasajero') or (i.persona.tipo_persona.tipo_persona == 'Pasajero' and i.persona.pasajero_frecuente == 0):
                personacliente.append({'id':i.persona.id,'nombre': i.persona.nombre+ ' ' +i.persona.apellido ,'tipo_persona':i.persona.tipo_persona.tipo_persona,'telefono':i.persona.telefono})
